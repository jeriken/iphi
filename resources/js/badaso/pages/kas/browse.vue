        ...
        <vs-col vs-lg="12">
          <vs-card>
            ...
            <div>
              ...
              >
                <template slot="thead">
                  <badaso-th sort-key="title"> Sumber </badaso-th>
                  <badaso-th sort-key="author"> Jumlah </badaso-th>
                  <badaso-th sort-key="category"> Tanggal </badaso-th>
                  <vs-th> Action </vs-th>
                </template>
                ...
                <template slot-scope="{ data }">
                  ...
                  >
                    ...
                    <vs-td :data="rec.jumlah">
                      {{ rec.jumlah }}
                    </vs-td>
                    <vs-td :data="rec.tanggal">
                      {{ rec.tanggal }}
                    </vs-td>
